 ...
 */
added: Array<number | null>, removed: Array<number | null>, };

export type CommitPerson = { person: PersonRef, 
/**
 ...
 */
commits_30d: number, people_30d: number, 
/**
 * Lines of code at HEAD, and those in files untouched for five years.
 */
code_lines: number, untouched_5y: number, };
