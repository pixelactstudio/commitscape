import type { Risk as Data } from "../api/types";
          ...
          <table>
            ...
            <tbody>
              {r.hotspots.map((h) => (
                <tr key={h.path}>
                  <td>
                    <Path path={h.path} onOpen={open.file} />
                  </td>
                  <td className="num">{grouped(h.churn)}</td>
                  <td className="num">{grouped(h.nesting)}</td>
                  <td className="note">
                    {ordinal(h.churn_place)} of {grouped(h.churn_of)} for changes, {ordinal(h.nesting_place)} of{" "}
                    {grouped(h.nesting_of)} for nesting
                  </td>
                </tr>
              ))}
            </tbody>
